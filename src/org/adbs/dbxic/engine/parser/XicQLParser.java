 ...
 ****************************************************/
  static final public Statement Start() throws ParseException {
    ...
    case UPDATE:
      o = ModifyTuple();
                                ...
                                {if (true) return new TupleModification(trplt.first, trplt.second, trplt.third);}
      break;
    case CATALOG:
      Catalog();
  ...
  static final public List<AlgebraicOperator> DisjunctiveExpression() throws ParseException {
    ...
    while (true) {
      ...
      DisjunctionOperator();
                                        {if (true) throw new ParseException("Disjunction not yet supported");}
  ...
  static final public AlgebraicOperator UnaryExpression() throws ParseException {
    ...
    case NOT:
      NegationOperator();
      BooleanExpression();
                                {if (true) throw new ParseException("Negation not yet supported.");}
      break;
    case OPENPAR:
      jj_consume_token(OPENPAR);
      BooleanExpression();
      jj_consume_token(CLOSEPAR);
                                {if (true) throw new ParseException("Nested expressions not yet supported.");}
      break;
    case ID:
  ...
  static final public Triplet<String, Pair<List<Variable>,List<Comparable>>, Proposition> ModifyTuple() throws ParseException {
        String table = null;
    ...
    jj_consume_token(WHERE);
    prop = IdProposition();
                        {if (true) return new Triplet<String, Pair<List<Variable>,List<Comparable>>, Proposition>(table, v, prop);}
    throw new Error("Missing return statement in function");
  }

  static final public Pair<List<Variable>,List<Comparable>> AttrValueList() throws ParseException {
    ...
    while (true) {
      ...
      l = Literal();
                vals.add(l);
                        ...
                        {if (true) return new Pair<List<Variable>, List<Comparable>>(vars, vals);}
    throw new Error("Missing return statement in function");
  }

  static final public Proposition IdProposition() throws ParseException {
        Variable leftVar = null;
        String val = null;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000,0x20000,0x40000,0x80000,0x0,0x0,0x0,0x0,0x4000,0x580,0x0,0x580,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x787,0x0,0x0,0x0,0x8000,0x8000,0x0,0x0,0x800000,0x0,0x7f0000,0x0,0x8000,0x80000000,0x8000,0x8000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x80,0x80,0x80,0x80,0x0,0x0,0x0,0x7f,0x0,0x0,};
   }
